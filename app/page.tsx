...
const Content: React.FC<ContentProps> = ({ title, items }) => {
  return (
    <section className="my-14 text-sm">
      <h2 className="mb-6 text-slate-900 dark:text-slate-100">{title}</h2>
    ...
    <>
      <div className="min-h-screen w-full relative bg-white dark:bg-neutral-900">
        ...
        <section className="my-9 text-sm">
          <h2 className="mb-1 text-slate-900 dark:text-slate-100">About</h2>
        ...
        <section className="my-14 text-sm">
          <h2 className="mb-6 text-slate-900 dark:text-slate-100">Contact</h2>
          <div className="flex flex-col gap-6">
                ...
                <div className="flex" key={index}>
                  ...
                  <div className="flex flex-col flex-1 text-slate-900 dark:text-slate-100">
                    <a
                      ...
                      aria-label={`${contact.value} (opens in new tab)`}
                      className="hover:underline inline-flex items-center gap-1 hover:text-slate-700 dark:hover:text-slate-200 transition-colors"
                    >
                      {contact.value}
                      <svg
                        width="12"
